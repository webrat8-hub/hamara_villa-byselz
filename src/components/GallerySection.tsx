...
export default function GallerySection() {
  ...
  const categories = ['All', 'Exterior', 'Bedroom', 'Living Area', 'Outdoor', 'Sunset', 'Bathroom', 'Kitchen'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="font-serif text-slate-600 font-light text-base sm:text-lg leading-relaxed">
            Take a visual tour through our beautifully renovated modern tropical villa. Enjoy direct access to the sea, private garden terraces, and beautifully cozy bedroom spaces.
          </p>
        </div>
            ...
            >
              ...
              <div className="text-center mt-5 text-white">
                <span className="font-sans text-[10px] tracking-widest text-gold-500 uppercase font-bold block mb-1">
                  {GALLERY_IMAGES[lightboxIndex].category} ({lightboxIndex + 1} / {GALLERY_IMAGES.length})
                </span>
