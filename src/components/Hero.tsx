  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center overflow-hidden bg-ocean-950 text-white">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-12 flex flex-col items-center justify-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-champagne/10 backdrop-blur-md border border-champagne/20 mb-8 animate-fade-in">
          ...
          <span className="font-sans text-xs tracking-widest text-champagne uppercase font-medium">
            Krui's Premium Private Beachfront Escape
          </span>
        </div>
        ...
        <p className="font-serif text-lg sm:text-xl text-sand-100/90 font-light max-w-3xl leading-relaxed mb-10 animate-fade-in-delayed">
          Experience premium beachfront living at Hamara Guest House—where luxury meets the absolute tranquility of Benawang Beach. Located in the quiet sanctuary of Pugung Walur, Krui.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 w-full max-w-4xl border-t border-white/10 pt-8 mt-4 text-center">
          <div>
            <span className="block font-sans text-xs tracking-widest text-champagne uppercase mb-1">Direct Access</span>
            <span className="block font-serif text-sm text-sand-100/90 font-light">Benawang Private Beach</span>
          </div>
          <div>
            <span className="block font-sans text-xs tracking-widest text-champagne uppercase mb-1">Modern Luxury</span>
            <span className="block font-serif text-sm text-sand-100/90 font-light">Beautifully Renovated</span>
          </div>
          <div>
            <span className="block font-sans text-xs tracking-widest text-champagne uppercase mb-1">Stay Connected</span>
            <span className="block font-serif text-sm text-sand-100/90 font-light">StarLink High-speed WiFi</span>
          </div>
          <div>
            <span className="block font-sans text-xs tracking-widest text-champagne uppercase mb-1">Eco-Conscious</span>
            <span className="block font-serif text-sm text-sand-100/90 font-light">Beach Cleaning Initiative</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 hidden md:flex flex-col items-center gap-2 text-sand-200/60 hover:text-white transition-colors cursor-pointer" onClick={scrollToCalculator}>
        <span className="font-sans text-[10px] uppercase tracking-widest font-medium">Explore Hamara</span>
