      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-serif text-slate-600 font-light text-sm sm:text-base leading-relaxed">
            Here is what surfers, remote workers, and families from all over the world say about their luxurious stay at Hamara Guest House.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.id}
              className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between relative"
            >
              {/* Quote Mark Accent */}
              ...
              <div>
                ...
                {/* Text */}
                <p className="font-serif text-slate-600 text-sm italic font-light leading-relaxed mb-6">
                  "{t.text}"
                </p>
              </div>
